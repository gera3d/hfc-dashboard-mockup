/**
 * Import second historical data source
 * 
 * Sheet: https://docs.google.com/spreadsheets/d/1jyyjA44sLgfzkwVUTF5s9a61jeboF4NXpHSC3CZZOPE/edit
 */
...
// Second historical sheet configuration
const HISTORICAL_SHEET_ID = '1jyyjA44sLgfzkwVUTF5s9a61jeboF4NXpHSC3CZZOPE';
const CREDENTIALS_PATH = './google-sheets-credentials.json';
const OUTPUT_FILE = './src/data/historical-reviews-2.json';
...
async function downloadHistoricalData() {
  try {
    console.log('🔍 Historical Data Import Script - Source 2');
    ...
    console.log('\n6️⃣ Saving to file...');
    const outputData = {
      source: 'Historical Reviews - Source 2',
    ...
    // 8. Summary
    console.log('\n' + '='.repeat(60));
    console.log('✅ IMPORT COMPLETE - SOURCE 2!');
    console.log('='.repeat(60));
