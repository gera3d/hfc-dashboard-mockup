  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5 md:gap-6">
        ...
        <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center justify-center w-12 h-12 bg-green-100 rounded-xl dark:bg-green-900/20">
              <ThumbsUp className="text-green-600 size-6 dark:text-green-400" />
            </div>
          ...
          <div className="flex-1">
            ...
            <h4 className="font-bold text-gray-800 text-title-xl dark:text-white/90">
              {fiveStarRate.toFixed(1)}%
            </h4>
            <span className="text-xs text-gray-500 mt-1 block">5-star rate</span>
          </div>
        ...
        <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
          {/* Top Section - Icon */}
          <div className="flex items-center justify-center w-12 h-12 mb-4 bg-blue-100 rounded-xl dark:bg-blue-900/20">
        ...
        <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
          {/* Top Section - Icon */}
          <div className="flex items-center justify-center w-12 h-12 mb-4 bg-amber-100 rounded-xl dark:bg-amber-900/20">
        ...
        <div className={`flex flex-col rounded-2xl border p-6 ${
          ...
          <div className="flex-1">
            ...
            <span className="text-xs text-gray-500 mt-1 block">1★+2★</span>
          </div>
